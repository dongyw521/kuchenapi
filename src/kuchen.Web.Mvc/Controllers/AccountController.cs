...
using kuchen.Sessions;
using kuchen.Web.Models.Account;
using kuchen.Web.Views.Shared.Components.TenantChange;

namespace kuchen.Web.Controllers
{
    public class AccountController : kuchenControllerBase
    {
